<template>
  <div class="header-component">
    <router-link to="/" class="header-logo"><img class="logo-my" src="../assets/logo.png" /></router-link>
    <router-link to="/articleWrite" class="btn write-btn"><i class="iconfont ic-articles"></i> 写文章</router-link>
    <router-link to="/signUp" class="btn sign-up" v-if="!navShow">注册</router-link>
    <router-link to="/signIn" class="btn sign-up" v-if="!navShow">登录</router-link>
      ...
      <ul class="nav navbar-nav">
        <li class="tab" v-if="!navShow" >
          <router-link to="/">
            ...
            <i class="iconfont ic-show menu-icon"></i>
          </router-link>
        </li>
        <li class="tab" v-if="!navShow" >
          <router-link to="/download" class="app-download-btn">
            <span class="menu-text">移动APP</span>
            <i class="iconfont menu-icon ic-ios"></i> | <i class="iconfont menu-icon ic-android"></i>
          </router-link>
        </li>
...
<style scoped>
  ...
  .sign-up {
    ...
    border: 1px solid rgba(18,157,222,.7);
    color: rgba(18,157,222,.7);
    border-radius: 20px;
    font-size: 15px;
  }
  .sign-up:hover {
