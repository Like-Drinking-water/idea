<template>
  <div class="sign">
    <div class="logo" style="padding-left: 15px"><a href="/"><img src="../../assets/logo.png"></a></div>
    <div class="main">
      <h4 class="title">
      ...
      <div class="signIn-container">
        <form action="#" id="new_session">
          <div class="input-prepend restyle js-normal">
            <input placeholder="登录通行证" type="text"  id="email_or_mobile_number" v-model="loginCode">
    ...
    login() {
      ...
      if (loginCode === '' || password === '') {
        ...
        this.axios({
          ...
          url: 'http://localhost:8503/v1/users/login/' + loginCode + '/' + password
        }).then((repos) => {
          if (repos.success == '登录成功') {
            this.user = repos

            this.$store.state.user = repos
...
.sign .main .title .active {
  font-weight: 700;
  color: #1298DE;
  border-bottom: 2px solid #1298DE;
}
.sign .main .title b {
  padding: 10px;
}
