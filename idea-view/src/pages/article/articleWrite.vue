<template>
  <div class="article">
    <div class="article_type">
      ...
      <div class="_1iZMb">
        <div class="_33Zlg" @click="newShow = !newShow"><i class="el-icon-edit"></i><span>选择广播</span></div>
        <div class="_2G97m" v-show="newShow">
          <form class="M8J6Q _1mU5v"><select v-model="typeName" name="name"
                                            class="_1CtV4">
...
<style scoped>
  * {
  ...
  ._3zibT a {
    ...
    padding: 9px 0;
    color: #1298DE;
    border: 1px solid rgba(18,157,222, .8);
    border-radius: 20px;
